...
<header class="header" >
  ...
  /* Green theme styles */
  .form-group label {
    color: #0c531e; /* Dark green for text labels */
  }
  .form-control {
    border: 1px solid #0c531e; /* Dark green borders for input fields */
    color: #004d40; /* Darker text color for input text */
  }
  .form-control:focus {
    border-color: #66bb6a; /* Lighter green for border focus */
    box-shadow: 0 0 8px #66bb6a; /* Add a subtle glow effect */
  }
  .btn-info {
    background-color: #4caf50; /* Material Design Green */
    border-color: #4caf50; /* Same as background */
  ...
  .form {
    border-top: 4px solid #4caf50; /* Green bar on top of the form */
    padding-top: 20px; /* Add some space above the form content */
  }
</style>
...
<form action="" method="post">
   <div class="row">
      ...
      <div class="form-group col-sm-12">
		 ...
		 <br></br>
		 <button type="button" onclick="getLocation()" class="btn btn-info">Get Current Location</button>
		 <br></br>
