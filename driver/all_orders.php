            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="all_orders.php"><i class="fa fa-th-large" aria-hidden="true"></i><span>Orders</span></a></li>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <?php
                                                    // Convert the address into a URL-encoded string
                                                    $addressUrlEncoded = urlencode($rows['address']);

                                                    // Create a Google Maps link for directions
                                                    $googleMapsLink = 'https://www.google.com/maps/dir/?api=1&destination=' . $addressUrlEncoded . '&travelmode=driving';
                                                    ...
                                                    echo ' <tr>
																					           <td>' . $rows['username'] . '</td>
																								...
																								<td>$' . $rows['price'] . '</td>
																								<td>' . $rows['address'] . '</td>
                                                                                                <td><a href="' . $googleMapsLink . '" target="_blank" class="btn btn-warning">Track</a></td>';
